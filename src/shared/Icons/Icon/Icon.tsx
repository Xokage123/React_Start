...
export function Icon(props: IIconProps) {
  ...
  const setIcon = () => {
    switch (name) {
      ...
      case 'comment':
        return <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
      ...
      case 'share':
        return <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="12" height="14" viewBox="0 0 12 14" fill="none">
      ...
      case 'save': 
        return <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
