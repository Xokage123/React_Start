...
export function Post({ score, username, title, date}: { score: number; username: string, date: string, title: string }) {
    ...
    <div className={styles.container}>
      <div className={styles.modal}>
        <div className={styles.header}>
            ...
            <TextContent username={username} date={date} className='textContent-modal' >
              <Title title={title}/>
            </TextContent>
          </div>
