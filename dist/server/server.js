...
"use strict";
eval("\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\r\n    result[\"default\"] = mod;\r\n    return result;\r\n};\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst React = __importStar(__webpack_require__(/*! react */ \"react\"));\r\nconst axios_1 = __importDefault(__webpack_require__(/*! axios */ \"axios\"));\r\nconst tokenContaxt_1 = __webpack_require__(/*! ../shared/context/tokenContaxt */ \"./src/shared/context/tokenContaxt.ts\");\r\nfunction usePostsData() {\r\n    const token = React.useContext(tokenContaxt_1.tokenContext);\r\n    const [postsData, setPostsData] = React.useState([]);\r\n    React.useEffect(() => {\r\n        axios_1.default.get('https://oauth.reddit.com/best', {\r\n            headers: { Authorization: `bearer ${token}` }\r\n        })\r\n            .then((resp) => {\r\n            const data = resp.data.data.children.map((item) => item.data);\r\n            const postsData = data.map((item) => ({ title: item.title, username: item.author, score: item.score, num_comments: item.num_comments, id: item.id, created: item.created, thumbnail: item.thumbnail }));\r\n            setPostsData(postsData);\r\n            console.log(data);\r\n        });\r\n    }, [token]);\r\n    return postsData;\r\n}\r\nexports.usePostsData = usePostsData;\r\n\n\n//# sourceURL=webpack:///./src/hooks/usePostsData.ts?");
...
/***/ "./src/shared/CardList/Card/TextContent/Title/Post/Post.tsx":
/*!******************************************************************!*\
  !*** ./src/shared/CardList/Card/TextContent/Title/Post/Post.tsx ***!
  \******************************************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nfunction __export(m) {\r\n    for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];\r\n}\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\n__export(__webpack_require__(/*! ./Post */ \"./src/shared/CardList/Card/TextContent/Title/Post/Post.tsx\"));\r\n\n\n//# sourceURL=webpack:///./src/shared/CardList/Card/TextContent/Title/Post/index.ts?");

/***/ }),

/***/ "./src/shared/CardList/Card/TextContent/Title/Post/post.scss":
/*!*******************************************************************!*\
  !*** ./src/shared/CardList/Card/TextContent/Title/Post/post.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
eval("// Exports\nmodule.exports = {\n\t\"modal\": \"post__modal--3Csnf\",\n\t\"title\": \"post__title--iT6qR\",\n\t\"content\": \"post__content--1oEJo\",\n\t\"header\": \"post__header--1R-li\"\n};\n\n\n//# sourceURL=webpack:///./src/shared/CardList/Card/TextContent/Title/Post/post.scss?");
...
"use strict";
eval("\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\r\n    result[\"default\"] = mod;\r\n    return result;\r\n};\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst react_1 = __importStar(__webpack_require__(/*! react */ \"react\"));\r\nconst title_scss_1 = __importDefault(__webpack_require__(/*! ./title.scss */ \"./src/shared/CardList/Card/TextContent/Title/title.scss\"));\r\nfunction Title({ title, children }) {\r\n    const [isModalOpened, setIsModalOpened] = react_1.useState(false);\r\n    return (react_1.default.createElement(\"h2\", { className: title_scss_1.default.title, onClick: () => { setIsModalOpened(true); } },\r\n        react_1.default.createElement(\"a\", { href: \"#post-url\", className: title_scss_1.default.postLink }, title),\r\n        isModalOpened && (children)));\r\n}\r\nexports.Title = Title;\r\n\n\n//# sourceURL=webpack:///./src/shared/CardList/Card/TextContent/Title/Title.tsx?");
...
"use strict";
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst react_1 = __importDefault(__webpack_require__(/*! react */ \"react\"));\r\nconst Card_1 = __webpack_require__(/*! ./Card */ \"./src/shared/CardList/Card/index.ts\");\r\nconst postsDataContext_1 = __webpack_require__(/*! ../context/postsDataContext */ \"./src/shared/context/postsDataContext.tsx\");\r\nconst cardlist_scss_1 = __importDefault(__webpack_require__(/*! ./cardlist.scss */ \"./src/shared/CardList/cardlist.scss\"));\r\nconst generateRandomIndex_1 = __webpack_require__(/*! ../utils/React/generateRandomIndex */ \"./src/shared/utils/React/generateRandomIndex.ts\");\r\nfunction CardList() {\r\n    const postsData = react_1.default.useContext(postsDataContext_1.postsDataContext);\r\n    return (react_1.default.createElement(\"ul\", { className: cardlist_scss_1.default.cardList }, postsData.map((item) => (react_1.default.createElement(Card_1.Card, { key: generateRandomIndex_1.generateRandomString(), id: item.id, username: item.username, title: item.title, score: item.score, num_comments: item.num_comments, thumbnail: item.thumbnail, created: item.created })))));\r\n}\r\nexports.CardList = CardList;\r\n\n\n//# sourceURL=webpack:///./src/shared/CardList/CardList.tsx?");
...
/***/ "./src/shared/context/postsDataContext.tsx":
/*!*************************************************!*\
  !*** ./src/shared/context/postsDataContext.tsx ***!
  \*************************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\r\n    result[\"default\"] = mod;\r\n    return result;\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst React = __importStar(__webpack_require__(/*! react */ \"react\"));\r\nconst usePostsData_1 = __webpack_require__(/*! ../../hooks/usePostsData */ \"./src/hooks/usePostsData.ts\");\r\nexports.postsDataContext = React.createContext({});\r\nfunction PostsDataContextProvider({ children }) {\r\n    const postsData = usePostsData_1.usePostsData();\r\n    return (React.createElement(exports.postsDataContext.Provider, { value: postsData }, children));\r\n}\r\nexports.PostsDataContextProvider = PostsDataContextProvider;\r\n\n\n//# sourceURL=webpack:///./src/shared/context/postsDataContext.tsx?");

/***/ }),

/***/ "./src/shared/context/tokenContaxt.ts":
/*!********************************************!*\
  !*** ./src/shared/context/tokenContaxt.ts ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\r\n    result[\"default\"] = mod;\r\n    return result;\r\n};\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nconst React = __importStar(__webpack_require__(/*! react */ \"react\"));\r\nexports.tokenContext = React.createContext('');\r\n\n\n//# sourceURL=webpack:///./src/shared/context/tokenContaxt.ts?");
